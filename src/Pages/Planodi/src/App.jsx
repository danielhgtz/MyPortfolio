...
const LandingAliados = loadable(() => import('./Pages/LandingAliados/LandingAliados'));
const PaquetesPage = loadable(() => import('./Pages/PaquetesPage/PaquetesPage'));
const ChangePassword = loadable(() => import('./Pages/ChangePassword/ChangePassword'));
const HomePage = loadable(() => import('./Pages/HomePage/HomePage'));
const RootTemplates = loadable(() => import('./Pages/RootTemplates/RootTemplates'));
const Explore = loadable(() => import('./Pages/Explore/Explore'));
const AfiliarmeIndex = loadable(() => import('./Pages/Afiliarme/AfiliarmeIndex'));
const MisNegociosIndex = loadable(() => import('./Pages/MisNegocios/MisNegociosIndex'));
const EditarNegocioIndex = loadable(() => import('./Pages/EditarNegocio/EditarNegocioIndex'));
...
function App() {
  return (
    <Switch>
      ...
      <Route exact path="/mis-negocios/:pathName" component={EditarNegocioIndex} />
